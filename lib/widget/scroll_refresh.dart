...
///通用下上刷新控件
class ScrollRefreshWidget extends StatefulWidget {
  ///item渲染
  ...
  @override
  _ScrollRefreshWidgetState createState() => _ScrollRefreshWidgetState();
}

class _ScrollRefreshWidgetState extends State<ScrollRefreshWidget> {
