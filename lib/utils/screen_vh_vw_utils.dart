...
class VhVwUtil {
  ...
  num vh(num height) => this.setHeight(height);
  num vw(num width) => this.setWidth(width);
  num vmin(num width) => min(this.setWidth(width), this.setHeight(width));
  num vmax(num width) => max(this.setWidth(width), this.setHeight(width));
}
